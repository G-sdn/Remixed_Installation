...
// Wifi settings
const char* ssid = "ConsoleWireless";
...
// Art-Net settings
ArtnetWifi artnet;
const int startUniverse = 3;  // CHANGE FOR YOUR SETUP most software this is 1, some software send out artnet first universe as 0.
