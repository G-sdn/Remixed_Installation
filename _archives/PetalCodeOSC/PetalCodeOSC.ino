...
// ***⌄⌄ LED variables ⌄⌄***
// Neopixel settings
const int numLeds = 72; //Number of LEDs
...
// void movePetal(OSCMessage &msg, int addrOffset) {
//   int servoOnOff = msg.getInt(0);
//   if (msg.getInt(0) < 0) {
//     servoOnOff = 1;
//   };
//   Serial.print("Servo: ");
